...
use crate::{self as ty, Interner, Region, RegionKind};
...
impl<T, I: Interner, E: Encoder> Encodable<E> for ty::Binder<I, T>
where
    T: Encodable<E>,
...
impl<T, I: Interner, D: Decoder> Decodable<D> for ty::Binder<I, T>
where

            ...
            |ecx| {
                ...
                for arg in goal.predicate.alias.own_args(cx).iter() {
                    ...
                    match ecx.structurally_normalize_term(goal.param_env, term) {
                        ...
                        Err(
                            e @ (NoSolutionOrRerunNonErased::NoSolution(NoSolution)
    ...
    I: Interner,
{
    ...
    fn fast_reject_assumption(
        ...
        if let Some(projection_pred) = assumption.as_projection_clause()
            && projection_pred.item_def_id() == alias_def_id
    ...
    fn match_assumption(
        ...
        let (assumption_projection_pred, goals ) = ecx.instantiate_binder_with_infer_and_goals(projection_pred);
